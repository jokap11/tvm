...
class Network:
    """ Represents a collection of Buffers and LayerOps to form a DFG (dependency graph). \n
    Input for Schedule Class """
    def __init__(self):
        self.bufs = []
        self.ops = []
...
class Schedule:
    ...
    def plot(self):
        """Can be used as inpout for .dot files (need Digraph graph name {} wrapper)"""
        out = ""
        prevOp = None
