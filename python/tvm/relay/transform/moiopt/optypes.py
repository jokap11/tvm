...
from .relay_util import isFlatten, isDepthwiseConv, RelayType
...
def getOpType(expr):
    ...
    if name == "reshape" and isFlatten(expr):
        return OpType.NONE
    ...
    if name in [
        ...
        inTy = RelayType(expr.args[0])
        outTy = RelayType(expr)
